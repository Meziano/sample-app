...
* Meziano/sample-app:v0.1
* Meziano/sample-app:v0.2

To deploy the application use deployment manifests stored in https://github.com/Meziano/sample-app-deployment
